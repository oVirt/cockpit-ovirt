...
const HeWizardStorage = ({
	collapsibleSections,
	deploymentType,
	errorMsg,
	errorMsgs,
	handleCollapsibleSectionChange,
	handleIscsiTargetRequest,
	...
	fcLunDiscoveryStatus,
	handleFcLunDiscoveryRequest,
	...
	targetRetrievalBtnClasses +=
		targetRetrievalStatus === status.POLLING ? " disabled" : "";

	let fcLunDiscoveryBtnClasses = "btn btn-primary";
	fcLunDiscoveryBtnClasses +=
		fcLunDiscoveryStatus === status.POLLING ? " disabled" : "";
		...
		<div>
			<form className="form-horizontal he-form-container">
				...
				{glusterSelected && (
					<div className="row">
						<div
							className="alert alert-info col-sm-8"
					...
					<div className={getClassNames("iSCSIPortalUser", errorMsgs)}>
						...
						<div className="col-md-6">
							<input
								...
								onChange={(e) =>
									handleStorageConfigUpdate("iSCSIPortalUser", e.target.value)
								}
							/>
					...
					<div className={getClassNames("mntOptions", errorMsgs)}>
						...
						<div className="col-md-6">
							<input
								...
								onChange={(e) =>
									handleStorageConfigUpdate("mntOptions", e.target.value)
								}
							/>
				...
				<span className={advancedSectionClasses}>
						...
						<div className={getClassNames("storageDomain", errorMsgs)}>
							...
							<div className="col-md-6">
								<input
									...
									onChange={(e) =>
										handleStorageConfigUpdate("storageDomain", e.target.value)
									}
								/>
					...
					<div style={iscsiSelected ? {} : { display: "none" }}>
						...
						{isAnsibleDeployment && (
							<div
								className={getClassNames("iSCSIDiscoverPassword", errorMsgs)}
							>
								<label className="col-md-3 control-label">
									Discovery Password
								</label>
