...
export function shutdownAllHostVmsConfirm () {
  confirmModal(_('Engine not accessible'),
    _('Login to Engine not available.<br/><b>Please confirm all VMs on this host will be shut down.</b><br/><br/><i>Please consider the type of running VMs. Shutting down critical VMs such as Hosted Engine can cause serious issues.</i>'),
    shutdownAllHostVms)
}
